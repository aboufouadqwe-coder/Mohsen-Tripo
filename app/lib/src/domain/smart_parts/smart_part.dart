...
final class ReferenceAnalysis {
  ...
  String get summary {
    if (isFullBody) {
      return 'تم اكتشاف شخصية كاملة؛ تم اقتراح الجسم والرأس والأطراف والملابس كأصول منفصلة.';
    }
    if (hasUpperBody) {
      return 'تم اكتشاف الجزء العلوي؛ تم اقتراح الرأس والجذع والملابس والأجزاء الظاهرة.';
    }
    if (hasFace) {
